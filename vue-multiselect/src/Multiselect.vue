  ...
  <div
    ...
    <div ref="tags" class="multiselect__tags">
      <slot
        ...
        :is-open="isOpen"
      >
        <div class="multiselect__tags-wrap" v-show="visibleValues.length > 0" refs="tagsWrap">
          <template v-for="(option, index) of visibleValues" @mousedown.prevent>
            <slot name="tag" :option="option" :search="search" :remove="removeElement">
              <span class="multiselect__tag" :key="index">
                <span v-text="getOptionLabel(option, true)"></span>
                <Icon @keypress.enter.prevent="removeElement(option)"
                  @mousedown.prevent="removeElement(option)" class="multiselect__tag-icon" size="8" stroke-width="2" type="x" :align="false"/>
              </span>
            </slot>
          </template>
        </div>
...
export default {
  ...
  computed: {
    ...
    hasTags(){
      return this.visibleValues.length > 0;
    },
